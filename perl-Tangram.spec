...
Tangram to klasa odwzorowań obiektowo-relacyjnych. Powoduje
przechowywanie obiektów w relacyjnych bazach danych i udostępnia
udogodnienia do odtwarzania i filtrowania ich. Tangram w pełni wspiera
programowanie zorientowane obiektowo, włącznie z polimorfizmem,
wielodziedziczeniem i kolekcjami. Czyni to na wzór ortogonalny, czyli
nie wymaga, aby klasy implementowały funkcje obsługi ani dziedziczyły
z klasy narzędziowej.
